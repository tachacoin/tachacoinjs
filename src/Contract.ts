...
export class Contract {
   ...
   *      [solar](https://github.com/tachacoin/solar). It includes the contract
   *      address, owner address, and ABI definition for methods and types.
   * @param opts - init options
   */
  constructor(private rpc: TachacoinRPC, public info: IContractInfo, opts: IContractInitOptions = {}) {
